              ...
              <tr>
                ...
                <td class="text-end pe-4">
                  <a href="#"
                     ...
                     onclick="abrirModalReativar(event, 'excluidos.php?reativar=<?= urlencode($lab->CNPJ_Lab) ?>', '<?= htmlspecialchars(addslashes($lab->Nome_Lab)) ?>')">♻ Reativar</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </tbody>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" style="border-radius:16px; overflow:hidden;">
        <div class="modal-header" style="background:#28a745;">
          <h5 class="modal-title text-white fw-bold" id="modalReativacaoLabel">♻ Reativar Laboratório</h5>
