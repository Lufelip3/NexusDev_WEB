...
<body class="d-flex flex-nowrap" style="font-family: 'Manrope', sans-serif;">
  ...
  <main class="b5-main p-4 p-md-5">
    <div class="d-flex align-items-center gap-3 mb-4">
      ...
      <div>
        <h1 class="display-6 fw-bold m-0" style="color:#1a1c4b;">Editar Drogaria</h1>
        ...
        <form action="atualizar.php" method="post" enctype="multipart/form-data">
          ...
          <div class="row g-3">
            <div class="col-12">
              ...
              <input type="text" name="drogaria[Nome_Drog]" class="form-control" value="<?= htmlspecialchars($a["Nome_Drog"]) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label fw-bold">CNPJ</label>
              <input type="text" class="form-control" value="<?= htmlspecialchars($a["CNPJ_Drog"]) ?>" disabled title="O CNPJ não pode ser alterado">
            </div>
            <div class="col-md-6">
              <label class="form-label fw-bold">Telefone de Contato</label>
              <input type="text" name="drogaria[Telefone_Drog]" class="form-control" value="<?= htmlspecialchars($a["Telefone_Drog"]) ?>">
            </div>
            <div class="col-12">
              <label class="form-label fw-bold">E-mail Comercial</label>
              <input type="email" name="drogaria[Email_Drog]" class="form-control" value="<?= htmlspecialchars($a["Email_Drog"]) ?>" required>
            </div>
            <div class="col-md-6">
              <label class="form-label fw-bold">CEP</label>
              <input type="text" name="drogaria[Cep_Drog]" class="form-control" value="<?= htmlspecialchars($a["Cep_Drog"]) ?>">
            </div>
            <div class="col-md-6">
              <label class="form-label fw-bold">Número (Endereço)</label>
              <input type="text" name="drogaria[Num_Drog]" class="form-control" value="<?= htmlspecialchars($a["Num_Drog"]) ?>">
            </div>
            <div class="col-12">
              <label class="form-label fw-bold">Foto / Logotipo</label>
              <?php if (!empty($a['Foto_Drog'])): ?>
                <div class="ph-lab-icon-wrap mb-3" style="width: 120px; height: 120px; border-radius: 12px;">
                   <img id="preview" src="../uploads/drogarias/<?= htmlspecialchars($a['Foto_Drog']) ?>" alt="Foto atual">
                </div>
              <?php else: ?>
                <div class="ph-lab-icon-wrap mb-3" style="width: 120px; height: 120px; border-radius: 12px; display: none;" id="previewContainer">
