          ...
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <?php if (!empty($a['Foto_Drog'])): ?>
                <img id="preview" src="../uploads/drogarias/<?= htmlspecialchars($a['Foto_Drog']) ?>" alt="Foto atual" style="display:block; width:100%; max-height:200px; object-fit:contain; border-radius:var(--ph-radius-sm); margin-bottom:12px;">
              <?php else: ?>
