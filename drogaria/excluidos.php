    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <div class="card border-0 bg-white shadow-sm" style="border-left: 4px solid #dc3545 !important;">
          <div class="card-body">
            <h6 class="text-secondary mb-1">Desativadas</h6>
    ...
    <div class="card card-pharma">
      <div class="card-body p-0">
        ...
        <div class="table-responsive">
          <table class="table table-pharma mb-0 align-middle">
            ...
            <tbody>
              ...
              <tr>
                <td class="ps-4 fw-bold text-secondary"><?= htmlspecialchars($drog->Nome_Drog) ?></td>
                <td><?= htmlspecialchars($drog->CNPJ_Drog) ?></td>
        ...
        <div class="p-5 text-center">
          <p class="text-secondary fs-5 mb-0">✅ Nenhuma drogaria desativada. Tudo limpo!</p>
        </div>
        <?php endif; ?>
      </div>
    </div>
