...
<head>
  ...
  <meta name="description" content="Drogarias desativadas – PharmaPulse ERP">
  <title>Drogarias Excluídas – PharmaPulse</title>
  ...
  <style>
    ...
    .ph-section-title { font-size: 1.25rem; font-weight: 700; color: #1e293b; }
    ...
    <header class="ph-topbar">
      <div class="ph-topbar-left">
        ...
        <div class="ph-topbar-titles">
          <h1 class="ph-page-title">Drogarias Desativadas</h1>
    ...
    <div class="ph-content">
      <div class="ph-deleted-section">
        ...
        <div class="ph-list-header">
          ...
          <a href="index.php" class="ph-action-btn-primary">← Voltar ao Painel</a>
        </div>
        ...
        <div class="ph-lab-list" id="ph-excluidos-list">
          ...
          <?php if ($excluidos) : ?>
            ...
            <div class="ph-lab-card">
              ...
              <div class="ph-lab-icon-wrap">🚫</div>
              ...
              <div class="ph-lab-actions-col">
                ...
                <a href="excluidos.php?reativar=<?= urlencode($drog->CNPJ_Drog) ?>"
                   ...
                   onclick="return confirm('Deseja reativar a drogaria <?= htmlspecialchars(addslashes($drog->Nome_Drog)) ?>?')">
                  ♻ Reativar
                </a>
              </div>
          ...
          <?php else : ?>
            <div class="ph-empty-state">
              ...
              <p>Nenhuma drogaria desativada. Tudo limpo!</p>
            </div>
          <?php endif; ?>
